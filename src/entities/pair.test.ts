...
describe('computePairAddress', () => {
  it('should correctly compute the pool address', () => {
    ...
    expect(result).toEqual('0xDb2BCF001F609528d9A5a80a92f09FE0479b0D36')
  })
...
describe('Pair', () => {
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual('0xfFAA10ED1633EAaE2a68abb084F9504C42689266')
    })
  })
  ...
  describe('miscellaneous', () => {
    ...
    it('getLiquidityValue:feeOn', async () => {
      ...
      expect(liquidityValue.currency.equals(tokenA)).toBe(true)
      expect(liquidityValue.quotient.toString()).toBe('833') // ceiling(1000 - (500 * (1 / 3)))
    })
  })
})
